...
Run `ng build @ropabajo/core` to build the project. The build artifacts will be stored in the `dist/` directory.

## Publishing

After building your library with `ng build @ropabajo/core`, go to the dist folder `cd dist/ng-core` and run `npm publish`.
